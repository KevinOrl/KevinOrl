...
- My preferred programming language is **Python**, while continuously learning advanced JavaScript, TypeScript, cloud technologies, and exploring Artificial Intelligence (from Machine Learning and Deep Learning to Reinforcement Learning).
- Building strong foundations through key university courses like **Software Security**, **Cybersecurity**, and **Operating Systems Principles**.
...
- Fun fact: I love solving puzzles and playing basketball.
